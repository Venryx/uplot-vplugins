...
export class Quadtree {
    ...
    split() {
        const t = this, x = t.x, y = t.y, w = t.w / 2, h = t.h / 2, l = t.l + 1;
        t.q = [
            // top right
    ...
    quads(x, y, w, h, cb) {
        const t = this, q = t.q, hzMid = t.x + t.w / 2, vtMid = t.y + t.h / 2, startIsNorth = y < vtMid, startIsWest = x < hzMid, endIsEast = x + w > hzMid, endIsSouth = y + h > vtMid;
        // top-right quad
